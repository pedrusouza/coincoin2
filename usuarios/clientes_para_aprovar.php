  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card-header">
          <h3 class="card-title">Clientes a aprovar</h3>
        </div>
            <!-- /.card-header -->
              ...
              <tbody>
              	<?php if ($usuarios) : ?>
	               	<?php foreach ($usuarios as $usuario) : ?>
		                <?php if(($usuario['privilegio']) == 0 && ($usuario['verificado']) == 0) : ?>
		                <tr>
                        ...
                        <a href="#" class="btn btn-sm btn-danger" class="fa fa-pencil" data-toggle="modal" data-target="#delete-modal-clientes-para-aprovar" data-usuario="<?php echo $usuario['id']; ?>"> Excluir</a>
		                  </td>
		                </tr>
		              	<?php endif; ?>
	    						<?php endforeach; ?>
 					...
 					<?php include('modal_clientes_para_aprovar.php'); ?>
          </div>
          </div>
            <!-- /.card-body -->
        </div>
