              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="actions text-right"> 
                    ...
                    <a href="#" class="btn btn-sm btn-warning" class="fa fa-pencil" data-toggle="modal" data-target="#insert-modal" data-usuario="<?php echo $usuario['id']; ?>"> Inserir CoinCoins</a>
